...
<section id="about" style="background:#f7f7f7 !important">
    ...
    <div class="row">
        ...
        <div class="nine columns main-col">
            ...
            <h2>About US</h2>
            <div id="about_me"><?php include "about_en.html"; ?></div>
            ...
            while($row = $e_qry->fetch_assoc()):
                ...
                <div class="row item">
                    ...
                    <div class="twelve columns">
                        ...
                        <h3><?php echo $row['title_en'] ?></h3>
                        <hr>
                        <img src="<?php echo validate_image($row['file_path']) ?>" alt="" class="img-fluid service-img-view">
                        <p>
                            <?php echo stripslashes(html_entity_decode($row['description_en'])) ?>
                        </p>
           ...
           --------------------------------------------------------------- -->
            ...
            <div id="modal-<?php echo $row['id'] ?>" class="popup-modal mfp-hide">
                ...
                <div class="description-box">
                    ...
                    <p><?php echo stripslashes(html_entity_decode($row['description_en'])) ?></p>
                </div>
                ...
                <div class="flexslider">
                    ...
                    <ul class="slides" id='testimonial-quotes'>
                        ...
                        while($row=$qry->fetch_assoc()):
                            $row['message_en'] = html_entity_decode($row['message_en']);
                            ?>
                            <li>
                                <blockquote>
                                    <p><?php echo $row['message_en'] ?>
                                    </p>
