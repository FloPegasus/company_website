...
<header id="home" style="background: #161415 url(<?php echo validate_image($_settings->info('banner')) ?>) no-repeat top center;">
    ...
    <nav id="nav-wrap">
        ...
        <a class="mobile-btn" href="#nav-wrap" title="Show navigation">Afficher navigation</a>
        <a class="mobile-btn" href="#" title="Hide navigation">Cacher navigation</a>

        <ul id="nav" class="nav">
            <li class="current"><a class="smoothscroll" href="#home">Accueil</a></li>
            <li><a class="smoothscroll" href="#about">Nous</a></li>
            ...
            <li><a class="smoothscroll" href="#contact_us">Nous contacter</a></li>
            <li>
                <a href="./">
                    <img src="<?php echo validate_image("/profile_asset/images/fr.png") ?>" >
                </a>
            </li>
            <li>
                <a href="./?lang=en">
                    <img src="<?php echo validate_image("/profile_asset/images/en.png") ?>" >
                </a>
            </li>
        </ul> <!-- end #nav -->
    ...
    <div class="text-container">
        ...
        <div class="row">
            ...
            <div class="two columns header-col">
                ...
                <h1><span>Témoignages de nos clients</span></h1>
...
<section id="contact_us">
    <div class="d-flex">
        <form action="" id="" style="width:100%" method="POST">
            <div class="col-lg-12">
                <h4 class="text-center text-light">Nous contacter</h4>
                <div class="d-flex">
                    <div class="col-lg-6">
                ...
                <div class='text-center'>
                    ...
                    <?php elseif(isset($msg_status) && $msg_status =='failed'): ?>
                        <span class="text-success">Message non envoyé.</span>
                    <?php endif; ?>
                </div>
                <center>
                ...
                <div>
                    <h2 class="text-light">Coordonées</h2>
                    <p class="address">
