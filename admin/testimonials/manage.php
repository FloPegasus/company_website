		...
		<div class="card-body">
			<form id="testimonial">
				...
				<div class="row">
					<div class="col-sm-12">
						<div class="form-group">
							<label for="" class="control-label">Testimony fr</label>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group">
                            <label for="" class="control-label">Testimony en</label>
                            <textarea name="message_en" id="" cols="30" rows="10" class="form-control summernote"><?php echo (isset($message)) ? html_entity_decode(($message)) : '' ?></textarea>
                        </div>
                    </div>
                </div>
				<div class="form-group">
