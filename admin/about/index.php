        ...
        <div class="card-body">
            <form id="about_c">
                <div class="form-group">
                    <input type="hidden" name="file" value="about">
                    <label for="" class="control-label">About Content</label>
                    <textarea name="content_en" id="" cols="30" rows="10" class="form-control summernote"><?php echo (is_file(base_app.'about_en.html')) ? file_get_contents((base_app.'about_en.html')) : '' ?></textarea>
                </div>
            </form>
        </div>
        <div class="card-footer">
