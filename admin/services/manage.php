		...
		<div class="card-body">
			<form id="service">
				<div class="row" class="details">
					...
					<div class="col-sm-6">
						<div class="form-group">
							<label for="title" class="control-label">Title fr</label>
                ...
                <div class="row" class="details">
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <textarea name="title_en" cols="30" rows="2" class="form-control"><?php echo isset($title_en) ? $title_en : '' ?></textarea>
                        </div>
                    </div>
                </div>
				<div class="row">
					<div class="col-sm-12">
						<div class="form-group">
							<label for="" class="control-label">Description fr</label>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group">
                            <label for="" class="control-label">Description en</label>
                            <textarea name="description_en" id="" cols="30" rows="10" class="form-control summernote"><?php echo (isset($description_en)) ? html_entity_decode(($description_en)) : '' ?></textarea>
                        </div>
                    </div>
                </div>
				<div class="row">
